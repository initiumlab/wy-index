...
var ResultCard = React.createClass({displayName: "ResultCard",
  render: function() {
    ...
    return (
      React.createElement("div", {id: "ResultCard", 
           style: cardStyle}, 

        React.createElement("div", {id: "indexMessage", 
             style: indexMessageStyle}, 
          this.props.indexMessage
        ), 

        React.createElement("div", {id: "indexBox", 
             style: indexBoxStyle}, 

          React.createElement("div", {id: "imageBoxLeft", 
               style: imageBoxLeftStyle}, 
            React.createElement("img", {src: "./images/resultpage_image_left.png"}), 
            React.createElement("div", {id: "indexLowerBound"}, 
              "0"
            )
          ), 

          React.createElement("div", {id: "imageBoxRight", 
               style: imageBoxRightStyle}, 
            React.createElement("img", {src: "./images/resultpage_image_right.png"}), 
            React.createElement("div", {id: "indexUpperBound"}, 
              "100"
            )
          ), 

          React.createElement("div", {id: "dataBox", 
               style: dataBoxStyle}, 
            this.props.totalScore, 
            React.createElement("div", {id: "sliderBox", 
                 style: sliderBoxStyle}, 
              "▼"
            ), 
            React.createElement("img", {src: "./images/gradient.png", 
                 id: "gradient", 
                 style: gradientStyle})
          )
        ...
        React.createElement("div", {id: "commentBox"}, 
          React.createElement("div", {id: "commentTitle", 
...
var QuestionCard = React.createClass({displayName: "QuestionCard",
  ...
  handleOptionClick: function(event) {
    ...
    if (this.state.questionSerial < this.props.survey.length - 1) {
      ...
      React.render(
          React.createElement(ResultCard, {totalScore: normalisedScore, 
  ...
  render: function() {
    ...
    var optionListItems = question.options.map(function(option){
      return (
          React.createElement("li", {key: option.optionScore + option.optionText, 
    ...
    return (
        React.createElement("div", {id: "QuestionCard", style: cardStyle}, 
          React.createElement("div", {id: "QuestionText", 
               style: questionTextStyle
          }, 
            question.questionText
          ), 
          React.createElement("div", {id: "OptionBox", 
              style: optionBoxStyle}, 
            React.createElement("ul", {id: "OptionList"}, 
              optionListItems
            ), 
            question.imagePath ?
              React.createElement("img", {id: "OptionImage", 
          ...
          React.createElement("div", {id: "ProgressBarBox", 
               style: progressBarBoxStyle}, 
            React.createElement("div", {id: "ProgressBar", 
                 style: progressBarStyle}, 
              React.createElement("div", {id: "divFinishedBar", 
                   style: finishedBarStyle}, 
                React.createElement("div", {id: "spanFinishedQuestionCount", 
            ...
            React.createElement("span", {id: "spanTotalQuestionCount", 
...
var CoverCard = React.createClass({displayName: "CoverCard",
  ...
  render: function() {
    ...
    return (
        React.createElement("div", {style: cardStyle}, 
          React.createElement("img", {src: this.props.coverImagePath, style: imageStyle}), 
          React.createElement("div", {id: "textBox", style: textBoxStyle}, 
